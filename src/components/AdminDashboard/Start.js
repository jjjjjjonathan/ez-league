  ...
  return (
    ...
    <div className="container mx-auto px-4 border border-black py-6">
      ...
      <div className="add-teams container px-4 py-3">
        ...
        <button className="my-2 px-4 py-2 border-2 border-gray-500 rounded-md bg-gray-400 hover:bg-gray-200" onClick={() => onClick("ADDTEAMS")}>Add Teams</button>
      </div>
      ...
      <div className="see-teams container px-4 py-3">
        ...
        <button className="my-2 px-4 py-2 border-2 border-gray-500 rounded-md bg-gray-400 hover:bg-gray-200" onClick={() => onClick("SEETEAMS")}>See Teams</button>
      </div>
      ...
      <div className="league-schedule container px-4 py-3">
        ...
        <button className="my-2 px-4 py-2 border-2 border-gray-500 rounded-md bg-gray-400 hover:bg-gray-200" onClick={() => onClick("SCHEDULE")}>League Schedule</button>
